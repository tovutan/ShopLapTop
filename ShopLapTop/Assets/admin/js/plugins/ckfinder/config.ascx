...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/Assets/hinhanh/sanpham/";
        ...
        // Thumbnails.Url = BaseUrl + Session["ID"] + "Thumbs" ?? "Diendan/";
        if ( BaseDir != "" ) {
            // Thumbnails.Dir = BaseDir + "_thumbs/";
            // Thumbnails.Dir = BaseDir + Session["ID"] + "Thumbs" ?? "Diendan/";
        }
        Thumbnails.Enabled = true;
        Thumbnails.DirectAccess = false;
        Thumbnails.MaxWidth = 192;
        Thumbnails.MaxHeight = 192;
        ...
        //type.Url = BaseUrl +  Session["ID"]+"/dien-dan/"+Session["name"]+"/";
        type.Url = BaseUrl;
        type.Dir = BaseDir == "" ? "" : BaseDir + "images/sanpham";
        type.MaxSize = 8388608;
